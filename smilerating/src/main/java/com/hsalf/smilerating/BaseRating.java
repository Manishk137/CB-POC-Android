...
public abstract class BaseRating extends View {
    ...
    public static final int GREATT = 5;

    protected int[] SMILES_LIST = new int[]{TERRIBLE, BAD, OKAY, GOOD, GREAT, GREATT};
    ...
    @IntDef({TERRIBLE, BAD, OKAY, GOOD, GREAT, GREATT, NONE})
...
//            smile.START_POINT = BaseRating.getPointByAngle(smileCenter, roundDegreeOfAngle(angle - 180), length / 2);
        ...
        private void createGreatSmileTT() {
            float div = 0.10f;
